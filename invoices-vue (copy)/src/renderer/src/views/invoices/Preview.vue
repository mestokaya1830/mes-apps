    ...
    <div class="preview-panel">
      <div class="printable">
        ...
        <!-- <div class="document-title">
          {{ title }}
          <span v-if="invoicesPreview.paid_amount && invoicesPreview.paid_amount > 0" class="status-badge">
            ⏱️ Teilweise bezahlt
          </span>
        </div> -->
        ...
        <!-- <div class="totals">
          ...
          <div v-if="invoicesPreview.events.paid_amount && invoicesPreview.events.paid_amount > 0"
      ...
      <!-- <ActionsButtonPreview v-if="invoicesPreview.selected_customer" :email="invoicesPreview.selected_customer.email"
...
export default {
  ...
  methods: {
    async getInvoicesPreview() {
      try {
        const result = await window.api.get('invoicesPreview')
        this.invoicesPreview = result
